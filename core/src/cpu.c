...
void cpu_execute(cpu_t* cpu, mmu_t* mmu, uint8_t opcode)
{
	...
	case 0x27: /* daa */
		tmp8 = 0;
		if (cpu->registers.flag_h || (!cpu->registers.flag_n && (cpu->registers.a & 0xF) > 9))
		{
			tmp8 |= 0x6;
		}

		if (cpu->registers.flag_c || (!cpu->registers.flag_n && cpu->registers.a > 0x99))
		{
			tmp8 |= 0x60;
			cpu->registers.flag_c = 0;
		}

		cpu->registers.a += cpu->registers.flag_n ? -tmp8 : tmp8;
		// if (cpu->registers.flag_z)
		// {
		// 	if (cpu->registers.flag_h) cpu->registers.a = (cpu->registers.a - 0x6) & 0xFF;
		// 	if (cpu->registers.flag_c) cpu->registers.a -= 0x60;
		// }
		// else
		// {
		// 	if (cpu->registers.flag_h || (cpu->registers.a & 0xF) > 9) cpu->registers.a += 0x6;
		// 	if (cpu->registers.flag_c || cpu->registers.a > 0x9F) cpu->registers.a += 0x60;
		// }

		// cpu->registers.flag_z = IS_ZERO(cpu->registers.a);
		// cpu->registers.flag_h = false;
		// cpu->registers.flag_c = cpu->registers.a >= 0x100;
		break;
	case 0x28: /* jr z, r8 */
		if (cpu->registers.flag_z)
		{
...
void cpu_execute_cb(cpu_t* cpu, mmu_t* mmu, uint8_t opcode)
{
	...
	case 0x12: /* rl d */
		...
		cpu->registers.b = (cpu->registers.d << 1) | cpu->registers.flag_c;
		cpu->registers.flag_z = IS_ZERO(cpu->registers.d);
		cpu->registers.flag_n = false;
		cpu->registers.flag_h = false;
		cpu->registers.flag_c = tmp8 >> 7;
	...
	case 0x16: /* rl (hl) */
		...
		mmu_poke8(mmu, cpu->registers.hl, (mmu_peek8(mmu, cpu->registers.hl) << 1) | cpu->registers.flag_c);
	...
	case 0x2D: /* sra l */
		...
		break;
	case 0x2E: /* sra (hl) */
		tmp8 = mmu_peek8(mmu, cpu->registers.hl) & 0x1;
	...
	case 0x45: /* bit 0, l */
		...
		break;
	case 0x46: /* bit 0, (hl) */
		cpu->registers.flag_z = !(mmu_peek8(mmu, cpu->registers.hl) & 0x01);
		cpu->registers.flag_n = false;
		cpu->registers.flag_h = true;
		break;
	case 0x47: /* bit 0, a */
	...
	case 0x4D: /* bit 1, l */
		...
		break;
	case 0x4E: /* bit 1, (hl) */
		cpu->registers.flag_z = !(mmu_peek8(mmu, cpu->registers.hl) & 0x02);
		cpu->registers.flag_n = false;
		cpu->registers.flag_h = true;
		break;
	case 0x4F: /* bit 1, a */
	...
	case 0x55: /* bit 2, l */
		...
		break;
	case 0x56: /* bit 2, (hl) */
		cpu->registers.flag_z = !(mmu_peek8(mmu, cpu->registers.hl) & 0x04);
		cpu->registers.flag_n = false;
		cpu->registers.flag_h = true;
		break;
	case 0x57: /* bit 2, a */
	...
	case 0x5D: /* bit 3, l */
		...
		break;
	case 0x5E: /* bit 3, (hl) */
		cpu->registers.flag_z = !(mmu_peek8(mmu, cpu->registers.hl) & 0x8);
		cpu->registers.flag_n = false;
		cpu->registers.flag_h = true;
		break;
	case 0x5F: /* bit 3, a */
	...
	case 0x6D: /* bit 5, l */
		...
		break;
	case 0x6E: /* bit 5, (hl) */
		cpu->registers.flag_z = !(mmu_peek8(mmu, cpu->registers.hl) & 0x20);
		cpu->registers.flag_n = false;
		cpu->registers.flag_h = true;
		break;
	case 0x6F: /* bit 5, a */
	...
	case 0x75: /* bit 6, l */
		...
		break;
	case 0x76: /* bit 6, (hl) */
		cpu->registers.flag_z = !(mmu_peek8(mmu, cpu->registers.hl) & 0x40);
		cpu->registers.flag_n = false;
		cpu->registers.flag_h = true;
		break;
	case 0x77: /* bit 6, a */
	...
	case 0x8D: /* res 1, l */
		...
		break;
	case 0x8E: /* res 1, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) & 0xFD);
		break;
	case 0x8F: /* res 1, a */
	...
	case 0x95: /* res 2, l */
		...
		break;
	case 0x96: /* res 2, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) & 0xFB);
		break;
	case 0x97: /* res 2, a */
	...
	case 0x9D: /* res 3, l */
		...
		break;
	case 0x9E: /* res 3, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) & 0xF7);
		break;
	case 0x9F: /* res 3, a */
	...
	case 0xA5: /* res 4, l */
		...
		break;
	case 0xA6: /* res 4, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) & 0xEF);
		break;
	case 0xA7: /* res 4, a */
	...
	case 0xAD: /* res 5, l */
		...
		break;
	case 0xAE: /* res 5, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) & 0xDF);
		break;
	case 0xAF: /* res 5, a */
	...
	case 0xB5: /* res 6, l */
		...
		break;
	case 0xB6: /* res 6, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) & 0xBF);
		break;
	case 0xB7: /* res 6, a */
	...
	case 0xBD: /* res 7, l */
		...
		break;
	case 0xBE: /* res 7, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) & 0x7F);
		break;
	case 0xBF: /* res 7, a */
	...
	case 0xC5: /* set 0, l */
		...
		break;
	case 0xC6: /* set 0, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) | 0x01);
		break;
	case 0xC7: /* set 0, a */
	...
	case 0xCD: /* set 1, l */
		...
		break;
	case 0xCE: /* set 1, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) | 0x02);
		break;
	case 0xCF: /* set 1, a */
	...
	case 0xD5: /* set 2, l */
		...
		break;
	case 0xD6: /* set 2, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) | 0x04);
		break;
	case 0xD7: /* set 2, a */
	...
	case 0xDD: /* set 3, l */
		...
		break;
	case 0xDE: /* set 3, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) | 0x08);
		break;
	case 0xDF: /* set 3, a */
	...
	case 0xE5: /* set 4, l */
		...
		break;
	case 0xE6: /* set 4, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) | 0x10);
		break;
	case 0xE7: /* set 4, a */
	...
	case 0xED: /* set 5, l */
		...
		break;
	case 0xEE: /* set 5, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) | 0x20);
		break;
	case 0xEF: /* set 5, a */
	...
	case 0xF5: /* set 6, l */
		...
		break;
	case 0xF6: /* set 6, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) | 0x40);
		break;
	case 0xF7: /* set 6, a */
	...
	case 0xFD: /* set 7, l */
		...
		break;
	case 0xFE: /* set 7, (hl) */
		mmu_poke8(mmu, cpu->registers.hl, mmu_peek8(mmu, cpu->registers.hl) | 0x80);
		break;
	case 0xFF: /* set 7, a */
